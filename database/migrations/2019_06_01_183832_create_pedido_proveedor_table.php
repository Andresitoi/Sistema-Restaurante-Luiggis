...
class CreatePedidoProveedorTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('pedido_proveedor', function (Blueprint $table) {
            ...
            $table->foreign('ci_empleado','fk_ciempleado_pedido_proveedor')
            ->references('ci')->on('empleado')->onUpdate('cascade')->onDelete('cascade');
            //asociado a la tabla proveedor(ci)
            $table->foreign('ci_proveedor','fk_ciproveedor_pedido_proveedor')
            ->references('ci')->on('proveedor')->onUpdate('cascade')->onDelete('cascade');
