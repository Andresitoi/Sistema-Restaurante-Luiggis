...
class CreateFacturaTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('factura', function (Blueprint $table) {
            ...
            $table->foreign('nro_pedidocliente','fk_codpedidocliente_factura')
            ->references('nro')->on('pedido_cliente')->onDelete('cascade')->onUpdate('cascade');
            
            //asociado a la tabla empleado(ci)
            $table->foreign('ci_empleado','fk_ciempleado_factura')
